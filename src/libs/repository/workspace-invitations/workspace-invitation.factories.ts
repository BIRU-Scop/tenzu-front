...
export function makeWorkspaceInvitation(overrides: Partial<WorkspaceInvitation> = {}): WorkspaceInvitation {
  return {
    ...makeInvitationBase(),
    workspace: makeWorkspaceLinkNested(),
    ...overrides,
  };
}

export function makePublicWorkspacePendingInvitation(
  overrides: Partial<PublicWorkspacePendingInvitation> = {},
