...
export function makeProjectInvitation(overrides: Partial<ProjectInvitation> = {}): ProjectInvitation {
  return {
    ...makeInvitationBase(),
...
export function makePublicProjectPendingInvitation(
  overrides: Partial<PublicProjectPendingInvitation> = {},
