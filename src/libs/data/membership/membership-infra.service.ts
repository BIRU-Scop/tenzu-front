...
export class MembershipInfraService {
  ...
  listWorkspaceInvitations(workspaceId: string) {
    return this.http.get<WorkspaceInvitationDetail[]>(`${this.workspacesUrl}/${workspaceId}/invitations`);
  }

  listProjectInvitations(projectId: string) {
    return this.http.get<ProjectInvitationDetail[]>(`${this.projectsUrl}/${projectId}/invitations`);
  }
  ...
  sendWorkspaceInvitations(workspaceId: string, invitationMail: string[]) {
    return this.http.post<CreateWorkspaceInvitationResponse>(`${this.workspacesUrl}/${workspaceId}/invitations`, {
  ...
  sendProjectInvitations(id: string, mails: string[]) {
    return this.http.post<CreateProjectInvitationResponse>(`${this.projectsUrl}/${id}/invitations`, {
